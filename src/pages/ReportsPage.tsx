...
import { ChevronLeft, ChevronRight, TrendingUp, TrendingDown, Banknote, PiggyBank, LineChart } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Income, expenses, savings and investment growth across the year."
        actions={
